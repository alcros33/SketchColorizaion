# based on https://github.com/Mukosame/Anime2Sketch
...
def create_model(gpu_ids=[]):
    ...
    ckpt = torch.load(BASE_DIR/'models'/'anime2sketch.pth')
...
class A2SModel(nn.Module):
    def __init__(self, mean=(0.5, 0.5, 0.5), std=(0.5, 0.5, 0.5)):
        super().__init__()
        self.norm = Normalizer(mean, std)
        self.model =  create_model()
    def forward(self, x):
        return (self.model(self.norm(x))+1)/2